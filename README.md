...
| 🎨 **Kritzeln & Raten** | `/kritzeln/` | **Echtzeit-Multiplayer** (2–8) — einer malt, die anderen raten live im Chat; Raum per Code teilen, Wortwahl, Live-Striche, Buchstaben-Hinweise, Runden, Punkte, Sieger:in & Revanche. Server = Durable Object (`DrawRoom`); dazu eine **dauerhafte, geräteübergreifende Bestenliste** (🏆), die das DO am Spielende autoritativ in D1 schreibt (Gesamtpunkte, Spiele, Siege, Bestleistung) |
